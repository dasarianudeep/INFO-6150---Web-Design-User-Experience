...
?>
    ...
    <a href="contact.php" class="btn btn-block btn-lg btn-primary">Proceed to Contact Information</a></div>
    </div>
    ...
    <div class="row">
     <div class="col-xs-2 textlable">
        ...
        <div class="col-xs-6">
          <div class="form-group">
            <input type="text" name="name" value="" placeholder="Please enter your full name" class="form-control" />
          </div>
        </div>
    </div>
    <div class="row">
     <div class="col-xs-2 textlable">
        ...
        <div class="col-xs-6">
          <div class="form-group">
            <input type="text" name="address" value="" placeholder="Full Address here" class="form-control" />
          </div>
        </div>
    </div>
    <div class="row">
     <div class="col-xs-1 textlable">
        ...
        <div class="col-xs-3">
          <div class="form-group">
            <input type="text" name="state" value="" placeholder="City" class="form-control" />
          </div>
        </div>
    </div>
    <div class="row">
     <div class="col-xs-1 textlable">
        ...
        <div class="col-xs-3">
          <div class="form-group">
            <input type="text" name="zip" value="" placeholder="Zip code" class="form-control" />
          </div>
        </div>
        <div class="col-xs-1">
          <div class="form-group">
